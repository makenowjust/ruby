...
make_counters! {
    ...
    exit {
        ...
        exit_io_buffer_not_embedded,
        exit_io_buffer_has_source,
        exit_io_buffer_readonly,
...
pub fn side_exit_counter(reason: crate::hir::SideExitReason) -> Counter {
    ...
    match reason {
        ...
        IOBufferNotEmbedded           => exit_io_buffer_not_embedded,
        IOBufferHasSource             => exit_io_buffer_has_source,
        IOBufferReadonly              => exit_io_buffer_readonly,
